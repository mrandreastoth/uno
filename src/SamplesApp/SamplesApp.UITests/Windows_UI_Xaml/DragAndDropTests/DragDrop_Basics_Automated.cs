...
namespace SamplesApp.UITests.Windows_UI_Xaml.DragAndDropTests
{
	public class DragDrop_Basics_Automated : SampleControlUITestBase
	{
		...
		private void RunTest(string? expectedData, [CallerMemberName] string? testName = null)
		{
			...
			_app.TapCoordinates(sourceBounds.CenterX - 10, sourceBounds.CenterY);
			_app.TapCoordinates(sourceBounds.CenterX - 20, sourceBounds.CenterY);
			...
			_app.TapCoordinates(goAway ? targetBounds.Right + 10 : targetBounds.CenterX, sourceBounds.CenterY + 100);
			_app.TapCoordinates(goAway ? targetBounds.Right + 10 : targetBounds.CenterX, sourceBounds.CenterY - 100);
